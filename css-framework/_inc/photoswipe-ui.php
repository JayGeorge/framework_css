...
=JFG. Default, except tidied up and I have modified the buttons. I've left the original buttons for preservation
        ...
        <div class="pswp__ui pswp__ui--hidden">
            <div class="pswp__top-bar">
                ...
                <button class="pswp__button pswp__button--close" title="Close (Esc)">
                    <svg class="c-jg-icon c-jg-icon--star"><use xlink:href="#c-jg-icon--star"></use></svg>
                </button>
